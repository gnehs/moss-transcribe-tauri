...
impl TryFrom<u32> for Dtype {
    ...
    fn try_from(value: u32) -> Result<Self, Self::Error> {
        match value {
            mlx_sys::mlx_dtype__MLX_BOOL => Ok(Self::Bool),
            mlx_sys::mlx_dtype__MLX_UINT8 => Ok(Self::Uint8),
            mlx_sys::mlx_dtype__MLX_UINT16 => Ok(Self::Uint16),
            mlx_sys::mlx_dtype__MLX_UINT32 => Ok(Self::Uint32),
            mlx_sys::mlx_dtype__MLX_UINT64 => Ok(Self::Uint64),
            mlx_sys::mlx_dtype__MLX_INT8 => Ok(Self::Int8),
            mlx_sys::mlx_dtype__MLX_INT16 => Ok(Self::Int16),
            mlx_sys::mlx_dtype__MLX_INT32 => Ok(Self::Int32),
            mlx_sys::mlx_dtype__MLX_INT64 => Ok(Self::Int64),
            mlx_sys::mlx_dtype__MLX_FLOAT16 => Ok(Self::Float16),
            mlx_sys::mlx_dtype__MLX_FLOAT32 => Ok(Self::Float32),
            mlx_sys::mlx_dtype__MLX_FLOAT64 => Ok(Self::Float64),
            mlx_sys::mlx_dtype__MLX_BFLOAT16 => Ok(Self::Bfloat16),
            mlx_sys::mlx_dtype__MLX_COMPLEX64 => Ok(Self::Complex64),
            _ => Err(()),
        }
    }
}
