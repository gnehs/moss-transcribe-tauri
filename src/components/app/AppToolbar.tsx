...
export function AppToolbar({
  ...
  return (
    <header
      className={cn(
        "flex min-h-12 items-center gap-3 border-b bg-muted/50 px-[18px] select-none max-[720px]:grid max-[720px]:grid-cols-[minmax(0,1fr)_auto] max-[720px]:px-3 max-[720px]:py-3",
        isMacOS && "pl-[86px]",
      )}
